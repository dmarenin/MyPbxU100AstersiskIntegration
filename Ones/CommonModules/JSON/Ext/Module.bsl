...
//
Функция лПрочитатьJSON(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь, ВосстанавливатьВнешСсылки=Ложь, ОтветКакСтруктура = ложь) Экспорт 
	
	Данные = jsonПрочитатьИнициализация(Значение, Стандарт, ПредставленияСсылок, ОтветКакСтруктура);
...
Функция jsonПрочитатьИнициализация(Значение, Стандарт, ПредставленияСсылок, ОтветКакСтруктура = Ложь)
	...
	// vera 20191013
	Если ОтветКакСтруктура тогда
		ВспомогательныеДанные.АвтоматическиПриводитьКСтруктуре = Истина;
	КонецЕсли;
	...
	ИначеЕсли (Символ = "{") Тогда																							// {
		...
		Иначе
			...
			Пока (Индекс <= Длина) Цикл
				...
				// Ключ.
				Начало = Индекс; КлючЭлемента = jsonПрочитать(Значение, Стандарт, ПредставленияСсылок, Индекс, Длина, ВспомогательныеДанные, СимволыФорматирования, Ложь); 
...
Функция jsonПрочитатьОпределитьДату(Значение)
	...
	Если (СтрДлина(Значение) = 20) или (СтрДлина(Значение) = 19) или (СтрДлина(Значение) = 24) или (СтрДлина(Значение) = 23) или (СтрДлина(Значение) = 26) Тогда
		
		Если (Сред(Значение, 05, 1) = "-") И				// -
			 (Сред(Значение, 08, 1) = "-") И				// -
			 (Сред(Значение, 11, 1) = "T") И				// T
			 (Сред(Значение, 14, 1) = ":") И				// :
			 (Сред(Значение, 17, 1) = ":") Или 				// :
			 (Сред(Значение, 20, 1) = "Z") Или
			 (Сред(Значение, 24, 1) = "Z")Тогда			// Z
			// Год. 
